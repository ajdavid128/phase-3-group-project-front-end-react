...
THE ARCHIVE showcases Aaron & Leah's favorite print artists and some of their work.

The focus of this project is building a Sinatra API backend that uses Active Record to access and persist data in a database, which will be used by a separate React frontend that interacts with the database via the API.

Users are able to:
- View a slideshow of all of the prints on the Home page.
- See all artists on the Artists page and add a new artist by submitting a form.
- Click on an artist on the Artists page to learn more about them and see their associated prints.
